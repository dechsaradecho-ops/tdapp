 ...
 * `execution.market_closed_discretionary_close_block` สำหรับเส้นทางปิดไม้
 * ทุกเส้นทาง (รวม SL/TP และ Emergency Exit) แบนเนอร์นี้คือหน้าตาของกฎนั้น:
 * บอกผู้ใช้ว่าตอนนี้ระบบงดเปิดออเดอร์ใหม่และงดปิดไม้ทุกกรณี
  ...
  return (
    ...
    >
      ...
      <div className="mt-1 text-xs text-amber-200/60">
        ตอนตลาดปิดไม่มีราคาจริงให้คิดกำไร/ขาดทุน และราคานิ่ง จึงปิดไม้ไม่ได้
        ทุกกรณี (รวม SL/TP และ Emergency Exit) — รอตลาดเปิดแล้วระบบจะจัดการต่อ
      </div>
    </div>
  );
}
